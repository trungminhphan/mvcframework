...
class __TwigTemplate_dbe316a31573974267c0004f04e9672c4118e014a1cf9391a8e0984b0279914d extends Twig_Template
{
                        ...
                        <table id=\"demo-foo-addrow2\" class=\"table table-bordered table-hover toggle-circle\">
                            ...
                            {% if list %}
                                ...
                                <tr>
                                    ...
                                    <td>{{item.ten}}</td>
                                    <td class=\"text-center\">
                                        <a href=\"/nha-san-xuat/delete?id={{item._id}}\" class=\"btn btn-sm btn-danger\" onclick=\"return confirm('Chắc chắn xóa?')\"><i class=\"mdi mdi-delete\"></i> Xóa</a>
...
{% endblock %}
", "Backend/Producer/list.html.twig", "C:\\wamp64\\www\\mvcframework\\App\\Views\\Backend\\Producer\\list.html.twig");
    }
}
