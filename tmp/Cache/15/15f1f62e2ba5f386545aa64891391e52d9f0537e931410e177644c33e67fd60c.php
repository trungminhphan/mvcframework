...
class __TwigTemplate_9ab0335eadbde3bb4dd2436af0d508e0254f6ff40442e86ed1a823931f5b9601 extends Twig_Template
{
...
";
    ...
    {
        return array (  151 => 79,  148 => 78,  127 => 59,  124 => 58,  114 => 54,  108 => 53,  103 => 51,  100 => 50,  94 => 48,  92 => 47,  87 => 45,  84 => 44,  79 => 43,  77 => 42,  39 => 6,  36 => 5,  30 => 3,  11 => 1,);
    }
...
{% block title %}Danh sách nhà sản xuất{% endblock %}
                        ...
                        <table id=\"demo-foo-addrow2\" class=\"table table-bordered table-hover toggle-circle\">
                            ...
                            {% if list %}
                                ...
                                <tr>
                                    ...
                                    <td>{{item.ten}}</td>
                                    <td class=\"text-center\">
                                        <a href=\"/nha-san-xuat/delete?id={{item._id}}&_token={{_token}}\" class=\"btn btn-sm btn-danger\" onclick=\"return confirm('Chắc chắn xóa?')\"><i class=\"mdi mdi-delete\"></i> Xóa</a>
                                        <a href=\"/nha-san-xuat/edit?id={{item._id}}\" class=\"btn btn-sm btn-info\"><i class=\"mdi mdi-pencil-circle\"></i> Sửa</a>
                                    </td>
                                </tr>
                                {% endfor %}
                            {% endif %}
...
{% endblock %}
", "Backend/Producer/list.html.twig", "E:\\www\\mvcframework\\App\\Views\\Backend\\Producer\\list.html.twig");
    }
}
