...
class __TwigTemplate_3b48aadd228f5d7e2098c864543b468e772392e9509843993d637426bc8f7a2f extends Twig_Template
{
                        ...
                        <table id=\"demo-foo-addrow2\" class=\"table table-bordered table-hover toggle-circle\" data-page-size=\"7\">
                            ...
                            {% if list %}
                                ...
                                <tr>
                                    ...
                                    <td>{{item.ten}}</td>
                                    <td class=\"text-center\">
                                        <a href=\"/nhom-san-pham/delete?id={{item._id}}&_token={{_token}}\" class=\"btn btn-sm btn-danger\" onclick=\"return confirm('Chắc chắn xóa?')\"><i class=\"mdi mdi-delete\"></i> Xóa</a>
...
{% endblock %}
", "Backend/ProductGroup/list.html.twig", "E:\\www\\mvcframework\\App\\Views\\Backend\\ProductGroup\\list.html.twig");
    }
}
